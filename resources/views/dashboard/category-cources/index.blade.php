...
@section('content')
    <main class="h-full overflow-y-auto">
        <div class="container px-6 mx-auto grid">
            ...
            <div class="mb-4">
                <a href="{{ route('create.category-cources') }}">
                    <button
                    ...
                    <table class="w-full whitespace-no-wrap">
                        <thead>
                            <tr
                                ...
                                <th class="px-4 py-3">Jumlah Cource</th>
                                <th class="px-4 py-3">Jumlah Teacher</th>
                                <th class="px-4 py-3">Jumlah Student</th>
                            ...
                            @foreach ($category as $item)
                                <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <td class="px-4 py-3 text-sm">
                                        {{ $item->cources->count() }} - Cource
                                    </td>
                                    <td class="px-4 py-3 text-sm">
                                        {{-- {{ $item->cources->teachers->count() }} --}}
                                    </td>
                                    <td class="px-4 py-3 text-sm">
                                        90 orang
                                    </td>
                                    ...
                                    <td class="px-4 py-3">
                                        ...
                                        <div class="flex items-center space-x-4 text-sm">
                                            ...
                                            <a href="{{ route('edit.category-cources', $item->id) }}"
                                            ...
                                            <form action="{{ route('category-cources.destroy', $item->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
