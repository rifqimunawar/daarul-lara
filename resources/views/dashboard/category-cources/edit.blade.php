    ...
    <main class="h-full overflow-y-auto">
        <div class="container px-6 mx-auto grid">
            ...
            <h4 class="mb-4 mt-4 text-lg font-semibold text-gray-600 dark:text-gray-300">
                Edit Category Cources
            </h4>
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                <form action="/dashboard/category/{{ $category->id }}/update" method="post"
                  enctype="multipart/form-data"> @csrf @method('put')
                    ...
                    <label class="block text-sm mb-4">
                      ...
                      <textarea name="description" rows="4"
                          ...
                          placeholder="Deskripsi Category Cource... (optional)">{{ $category->description }}</textarea>
                  </label>                                  
                    ...
                    <label class="block text-sm mb-4">
                      ...
                      <div class="flex items-center justify-center w-full">
                          <label for="dropzone-file"
                              ...
                              <input id="dropzone-file" type="file" class="hidden" name="img" value="{{ $category->img }}"/>
                          </label>
                      </div>
                  </label>
