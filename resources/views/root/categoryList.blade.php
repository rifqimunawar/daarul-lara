        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Category</h1>
    ...
    <div class="container-xxl py-5 category">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Courses Categories {{ $category->name }}</h1>
            </div>
            ...
            <div class="list-group wow fadeInUp" data-wow-delay="0.5s">
                ...
                @foreach ($category->cources as $cource)
                    <a href="/cource/{{ $cource->id}}/detail" class="list-group-item list-group-item-action">
                        <div class="d-flex w-100 justify-content-between">
                            <div class="d-flex">
                                <img src="{{ asset('img/' . $cource->img) }}" class="w-24" alt="">
                                <h4 class="m-3 pt-2 test-start">{{ $cource->name }}</h4>
                            </div>
                            <small class="text-body-secondary">
                                @if ($cource->status === 0)
                                    Kelas Penuh
                                @elseif ($cource->status === 1)
                                    Kelas Tersedia
                                @endif
                            </small>
                        </div>
